...
- Update documentation (`docs/spec/materialization.md`, `docs/agent-commands.md`) to state that subagent use is mandatory when supported, and that invocation context (brief) is passed when available
...
- Documentation (`docs/spec/materialization.md`, `docs/agent-commands.md`) reflects that subagent use is required when supported, and that brief is passed when available
